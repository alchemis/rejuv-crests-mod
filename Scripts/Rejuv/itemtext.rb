...
:AUROCREST => {
	:ID => 1701, 
	:name => "Aurorus Crest",
	:desc => "Changes Aurorus' Rock-type to Dragon; Rock-type moves become Dragon and are boosted by 20%. Activates Aurora Veil on entry if Hail is active.",
	:price => 0,
	:crest => true,
	:noUseInBattle => true,
	:noUse => true,
...
:HELIOCREST => {
	...
	:desc => "Changes Heliolisk's Normal-type to match its ability; Its Normal-type moves are changed to match and are boosted by 20%.",
	:price => 0,
	:crest => true,
	:noUseInBattle => true,
	:noUse => true,
...
:ARMALCREST => {
	:ID => 1904,
	:name => "Armaldo Crest",
	:desc => "Changes Armaldo's Rock-type to Steel. Special Defense is boosted by 50% and HP is restored each turn.",
	:price => 0,
	:crest => true,
	:noUseInBattle => true,
	:noUse => true,
